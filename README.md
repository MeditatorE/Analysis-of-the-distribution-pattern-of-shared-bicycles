...
We show the flow of bicycles in and out of each station on the map. **It can be seen that the stations with bicycle inflow are concentrated in the urban area, while the stations with bicycle outflow are concentrated in the suburbs (such as Columbia Heights, Woodley Park).** We have provided an interactive map for this section. Please download washington_map_in_out.html and open it in your browser.
